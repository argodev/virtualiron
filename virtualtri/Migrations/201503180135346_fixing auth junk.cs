namespace virtualtri.Migrations
{
    ...
    public partial class fixingauthjunk : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.AspNetUsers", "EmailAddress", c => c.String(nullable: false));
            ...
            AlterColumn("dbo.AspNetUsers", "DateStarted", c => c.DateTime(nullable: false));
            AlterColumn("dbo.AspNetUsers", "DateCompleted", c => c.DateTime(nullable: false));
        ...
        public override void Down()
        {
            ...
            DropPrimaryKey("dbo.AspNetUserLogins");
            AlterColumn("dbo.AspNetUsers", "DateCompleted", c => c.DateTime());
            AlterColumn("dbo.AspNetUsers", "DateStarted", c => c.DateTime());
